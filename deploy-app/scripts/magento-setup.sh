...
echo "*/2 * * * * aws s3 sync /var/www/html/magento/pub/static s3://${static_bucket_name}/" > /tmp/crontab
echo "*/2 * * * * aws s3 sync /var/www/html/magento/pub/media s3://${media_bucket_name}/" >> /tmp/crontab
crontab /tmp/crontab
